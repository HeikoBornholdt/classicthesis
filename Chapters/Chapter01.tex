...
\begin{itemize}
    ...
    \item Typography:
        \begin{itemize}
            ...
            A slight variation of the default style is \texttt{linedheaders}: it changes the look of the chapter headings a bit by adding a horizontal line above the chapter title. The chapter number will also be moved to the top of the page, above the chapter title.
